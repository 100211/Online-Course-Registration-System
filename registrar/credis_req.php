			...
			<div class="span12">	
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Unconfirmed Students Who Request for Take Less Than 15 Credits</strong>
                                </div>
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select * from students where req = 'send' ")or die(mysql_error());
                                  ...
                                  <!--  <td><?php echo $row['password']; ?></td> -->                                 
                                    ...
                                    <td width="200">
											...
											<?php include('confirm1_request.php') ?>
                                        ...
                                        <?php include('delete1_student_modal.php'); ?>
                                    </td>
