...
<div class="container">
  ...
  <p class="largetxt" style="font-size:16px"><b>Choose Date For Course Registration Duration</b></p>
   </br>
  From:
  <?php
					$thisweek = date('W');
  ...
  <?php
				  ...
				  $myCalendar->writeScript();
				  ?>
  <input type="button" name="button2" id="button2" value="Set the Date" onClick="trackIt(this.form.date3.value,this.form.date4.value);">
  
</br></br></br><p class="largetxt" style="background-color:#FF0000"><b><marquee behavior="slide">Date Of Previous Registration</marquee></b></p>
