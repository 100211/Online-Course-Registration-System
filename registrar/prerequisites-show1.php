...
<div class="container">
		<div class="margin-top">
			<div class="row">
               ...
               <form id="form1" method="post" action="prerequisites-model21.php">
              <!-- prerequization code -->
              ...
              <!-- end of prerequization -->
				...
				<a href="prerequisites1.php">Set Prerequisites</a>
  ...
  $(document).ready(function(){
    ...
    $(document).on("change", ".select_course", function () {
                ...
                $.ajax({
                    type:"POST",
                    data:"id="+id,
                    url: "prerequisites-show-model1.php?id="+id,
                    dataType: "html",
    ...
    $(document).on("click", "#req_del", function () {
                ...
                $.ajax({
                    type:"POST",
                    data:"id="+id,
                    url: "prerequisites-del-model1.php?id="+id,
                    dataType: "html",
                    success: function(data){
                        $( ".show_all_pre" ).html(data);
                }});
