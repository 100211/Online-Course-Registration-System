 ...
 */
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysql_query("select Distinct  `student_no` from registration ")or die(mysql_error());
                              ...
                              /*       <td><?php echo $row['gender']; ?></td> 
                                    ...
                                    <td width="60"><img src="<?php echo $subject_row['photo']; ?>" width="60" height="60" class="img-circle"></td> 
									 <td width="80"><?php echo $subject_row['year_level']; ?></td> 
									 <td width="80"><?php echo $subject_row['term']; ?></td> 
                                      <td width="80"><?php echo $subject_row['contact']; ?></td> 
