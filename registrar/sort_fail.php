 ...
 */
           ...
           </br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a style="font-size:25px">  Session:&nbsp; <?php echo $year_level;  ?> </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<a style="font-size:25px">   Subject:&nbsp; <?php echo $course ?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a style="font-size:25px">&nbsp;&nbsp;&nbsp;
					<a style="font-size:25px;color:#FF0000">   Letter Grade:&nbsp; <?php echo "F" ?></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a style="font-size:25px">
                    </div>    
                                  <?php  $user_query=mysql_query("select * from result where `Grade_Point` = '0' and `sub_code` like '%$course%' and session like '%$year_level%' ")or die(mysql_error());
                              ...
                              /*       <td><?php echo $row['gender']; ?></td> 
                                    ...
                                    <td width="60"><img src="<?php echo $subject_row['photo']; ?>" width="60" height="60" class="img-circle"></td> 
									 <td width="70"><?php echo $row['year']; ?></td> 
									 <td width="70"><?php echo $row['term']; ?></td> 
									<?php if($year_level==null){ ?>  <td width="80"><?php echo $row['session']; ?></td> <?php } ?>
                                 <!--   <td width="80"><?php echo $row['Letter_Grade']; ?></td> -->
