...
$pic=$_SESSION['pic'];
  ...
  $total_credi = 0.00;
			...
			$tgpa=0.00;
			 ...
			 $var11 = mysql_query("select * from result where student_id ='$get_roll' and term ='1' and year ='1' ");
  ...
  $total_credi12 = 0.00;
			...
			$tgpa12=0.00;
			 ...
			 $var1112 = mysql_query("select * from result where student_id ='$get_roll' and term ='2' and year ='1' ");
 ...
 $total_credi21 = 0.00;
			...
			$tgpa21=0.00;
			 ...
			 $var1121 = mysql_query("select * from result where student_id ='$get_roll' and term ='1' and year ='2' ");
			...
			$var1122 = mysql_query("select * from result where student_id ='$get_roll' and term ='2' and year ='2' ");
...
$total_credi31 = 0.00; 
          $earned_credi31 = 0.00;
			...
			$tgpa31=0.00;
			 ...
			 $var1131 = mysql_query("select * from result where student_id ='$get_roll' and term ='1' and year ='3' ");
...
$total_credi32 = 0.00;
			...
			$tgpa32=0.00;
			 ...
			 $var11 = mysql_query("select * from result where student_id ='$get_roll' and term ='2' and year ='3' ");
			 $rows11 = mysql_num_rows($var11);
			 for($i=0 ; $i<$rows11 ; $i++)
			 {
 ...
 $total_credi41 = 0.00;
			...
			$tgpa41=0.00;
			 ...
			 $var11 = mysql_query("select * from result where student_id ='$get_roll' and term ='1' and year ='4' ");
			 $rows11 = mysql_num_rows($var11);
			 for($i=0 ; $i<$rows11 ; $i++)
			 {
			   $ary = mysql_fetch_array($var11);
 ...
 $total_credi42 = 0.00;
			...
			$tgpa42=0.00;
			 ...
			 $var11 = mysql_query("select * from result where student_id ='$get_roll' and term ='2' and year ='4' ");
			 $rows11 = mysql_num_rows($var11);
			 for($i=0 ; $i<$rows11 ; $i++)
			 {
			   $ary = mysql_fetch_array($var11);
...
$total_credit = 0;
			 ...
			 $var = mysql_query("select * from registration where student_no = '$get_roll' and term = '$get_term' and year = '$get_year' and session = '$get_session'");
...
$result=mysql_query("select * from registration where student_no = '$get_roll' and term = '$get_term' and year = '$get_year' and session = '$get_session'");
...
$pdf->SetFont('Arial','',10);
$pdf->write('10',"Student No.       :  ".$get_roll."    ");
$pdf->Ln(7);
